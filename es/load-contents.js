...
//contenzioso-table.html
    ...
    appendORreplace('.Em04b', "Agricultura - ajo");
    ...
    appendORreplace('.Em09b', "Tasa fiscal de desembarque de cereales");
...
appendORreplace('#F1',"En particular, los socios de la Firma - además de los asuntos patrocinados ante tribunales nacionales (Italia, Alemania, Belgica, Francia) -  han patrocinado casi setenta procedimientos ante el Tribunal de Justicia de la Unión Europea en Luxemburgo. ");
    ...
    appendORreplace('#F19', "Posteriormente, la abogada VISCARDINI ha recibido la ayuda de sus hijos, el abogado Gabriele DONÀ y la abogada Simonetta DONÀ, ambos con amplia experiencia profesional y académica. ");
...
//azioni_ue.html
    ...
    appendORreplace('#S83',"Los socios de la firma tienen una considerable experiencia con estos procedimientos - habiendo aparecido en casi setenta procedimientos ante el Tribunal General y el Tribunal de Justicia de la Unión Europea en Luxemburgo. ");
