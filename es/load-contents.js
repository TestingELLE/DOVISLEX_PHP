...
//professionisti.html
    ...
    appendORreplace('#F23', "Autora para el Grupo 'Il Sole-24 Ore' de artículos sobre Derecho comunitario, en particular, comentando sobre las sentencias del Tribunal de Primera Instancia y el Tribunal de Justicia Europeo (1999)&nbsp;<button id="pair1" data-href="#collapse1" class="nav-toggle notranslate" onclick="plus(this)">&raquo; plus</button>");
