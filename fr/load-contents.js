...
function loadContents() {
    ...
    appendORreplace('#F23', "• Auteur pour 'Il Sole-24 Ore' d'articles concernant le droit communautaire, et notamment les arrêts du Tribunal de première instance et de la Cour de justice des Communautés européennes (1999)&nbsp;<button id="pair1" data-href="#collapse1" class="nav - toggle notranslate" onclick="plus(this)">&raquo; plus</button>");
...
//contenzioso.html
    ...
    appendORreplace('.Em14', "Douanes");
    appendORreplace('.Em15', "Impôt de consommation");
    ...
    appendORreplace('.Fm30', "Aides à l'extensification de la production");
    ...
    appendORreplace('#E312', "Liberté de circulation des travailleurs");
...
//concorrenza
    ...
    appendORreplace('#F49', "aides d'Etat");
