<div id="main-content">
    ...
    <article class="clearfix_new">
        <h2 class="noTextTransform notranslate">Gabriele DONÀ<img class="right clearfix" style="margin: 0 10px;" 
                                                                  src="../images/Foto_Avv_G_Dona_2.jpg" alt="Foto Avvocato Gabriele Donà"></h2>
        ...
        <div class="more">
            ...
            <div id="collapse2" style="display:none">
                ...
                <div class="notranslate"> <!-- papers -->
                    ...
                    <p>&#149;&nbsp;<span class="Fm11">Speaker on </span> "I principi di non discriminazione e di libertà di circolazione degli sportivi professionisti nella giurisprudenza della Corte di giustizia dell'Unione europea”, as part of the Convegno “Discriminazioni nello sport e autonomia dei privati” organized by the Commissione “Diritto dello sport” and by the Delegazione “Catania e Sicilia orientale” of the European Lawyers' Union (UAE) (Fiumefreddo, 23 September 2016)</p>
