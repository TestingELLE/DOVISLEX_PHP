        ...
        <div>
            ...
            <div class="more">
                ...
                <p class="LcustomTranslation" id="F23">&#149;&nbsp;Author for the Group "Il Sole-24 Ore" of &nbsp;
                    ...
                    of Justice European (1999)&nbsp;<button id="pair1" data-href="#collapse1" class="nav-toggle notranslate" onclick="plus(this)">&raquo; plus</button></p>                
        ...
        <div>
            ...
            <div class="more">
                ...
                <ul>
                    ...
                    <li class="LcustomTranslation" id="D14">Belgian and German jurisdictions  as well as in national and international arbitration.&nbsp;<button id="pair2" data-href="#collapse2" class="nav-toggle notranslate" onclick="plus(this)">&raquo; plus</button>
                    </li>
                </ul>
        ...
        <div>
            ...
            <div class="more">
                ...
                <p class="LcustomTranslation" id="D19">Professor of Italian commercial, corporate and contractual 
                    ...
                    Germany (since 2001)&nbsp;<button id="pair3" data-href="#collapse3" class="nav-toggle notranslate" onclick="plus(this)">&raquo; plus</button>
            ...
            <div class="more">
                <ul>
                    ...
                    <li class="LcustomTranslation" id="D23">Previously, attorney at a leading firm 
                        ...
                        in litigation - Padova - Italy (2002-2012)&nbsp;<button id="pair4" data-href="#collapse4" class="nav-toggle notranslate" onclick="plus(this)">&raquo; plus</button></li> 
                </ul>
        ...
        <div>
            ...
            <div class="more">
                <ul>
                    ...
                    <li class="LcustomTranslation" id="D27">Representation before German Courts and Jurisdictions.&nbsp;<button id="pair5" data-href="#collapse5" class="nav-toggle notranslate" onclick="plus(this)">&raquo; plus</button></li> 
                </ul>
